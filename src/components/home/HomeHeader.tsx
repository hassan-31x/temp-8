      ...
      <header className="absolute inset-x-0 top-0 z-20 flex h-20 items-center justify-between px-6 lg:px-12 border-b border-white/10 bg-black/30 backdrop-blur-sm text-white">
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center">
          <Link href="/" className="flex items-center hover:opacity-80 transition-opacity">
            ...
            <span className="text-3xl xl:text-4xl font-black tracking-widest uppercase">TEMPLATE</span>
          </Link>
        </div>

        <div className="flex items-center gap-6">
          <a href="tel:01484480777" className="hidden lg:flex items-center gap-2 hover:text-red-500 transition-colors">
            <Phone className="h-4 w-4 text-red-500" />
            <span className="font-semibold tracking-wider">01484 480777</span>
          </a>
          <div className="hidden sm:flex items-center">
            <div className="flex items-center gap-2 sm:gap-4 ml-6">
              <div className="h-10 w-[1px] bg-white/20"></div>
              <a href="#" className="hover:text-red-500 transition-colors flex items-center justify-center p-1">
      ...
      >
        ...
        <div className="border-t border-white/10 px-10 py-8 flex flex-col gap-4">
          ...
          >
            ...
            <span className="font-semibold tracking-widest text-sm">01484 480777</span>
          </a>
          <a
            href="mailto:SALES@S-S-C.CO.UK"
            className="flex items-center gap-4 text-white hover:text-red-500 transition-colors group"
          >
            <span className="flex items-center justify-center w-9 h-9 rounded-full border border-red-600 group-hover:bg-red-600 transition-colors shrink-0">
            ...
            <span className="font-semibold tracking-widest text-sm uppercase">SALES@S-S-C.CO.UK</span>
          </a>
        </div>
      </nav>
    </>
