    ...
    '@graph': [
      {
        ...
        sameAs: [
          'https://www.facebook.com/mwaautos',
          'https://www.instagram.com/mwaautos',
          'https://www.linkedin.com/company/mwa-autos'
        ]
      },
      {
        '@type': 'WebSite',
        '@id': `${baseUrl}/#website`,
        url: baseUrl,
        name: 'MWA Autos - Used Car Dealers Nottingham',
      ...
      },
      {
        ...
        '@id': `${baseUrl}/#webpage`,
        url: baseUrl,
        name: 'MWA Autos - Trusted Used Car Dealers Nottingham | Quality Pre-Owned Vehicles',
        isPartOf: {
          '@id': `${baseUrl}/#website`
        },
        about: {
        ...
        description: 'MWA Autos - Your reliable family-run used car dealer in Nottinghamshire. Quality used cars from Audi, BMW, Ford, Mercedes & more.',
        breadcrumb: {
